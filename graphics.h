...
class object {
   ...
   public:
	  ...
	  object(){};
	  object(shared_ptr<shape> s, vertex c, rgbcolor cl): pshape(s), center(c), color(cl){};
      void draw(int i) {
	  ...
	  void change_x(GLfloat x){ 
		center.xpos = x;
	  }
	  void change_y(GLfloat y){
		center.ypos = y;
	  }
};
...
class window {
   ...
   public:
	  ...
	  static void setdelta (GLfloat d) { m_delta = d; }
      static void main();
};
